...
NODE_INPUT_TOOLTIPS = {
    ...
    "MiniMaxStructuredPromptV20": {
        ...
        "lyrics": "Whether the song has lyrics: yes, sparse or instrumental. Select 'custom' to leave this part out of the LLM prompt.",
        "language": "Lyrics language. Select 'custom' to leave this part out of the LLM prompt.",
