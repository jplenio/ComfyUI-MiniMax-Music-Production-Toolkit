...
- Auch optionale Widgets können positionsbasierte `widgets_values` verschieben. Änderungen mit `workflow_schema.py`, `web/workflow_migration.js`, `web/migration_utils.js` und den Vertragstests prüfen.
