...
- `scripts/workflow_schema.py` (moved out of the package root on 2026-09-17; it is a pure tool module with no toolkit imports): serialized parser/JSON input-order migrations and external-node detection. Its current traversal is top-level only.
